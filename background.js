...
chrome.contextMenus.onClicked.addListener(async (info) => {
    ...
    if (!userVariables.translateStatus) {            
        let response = await fetch('http://ttsh-backend.gsgse7cgfjf9ggf6.eastus.azurecontainer.io:3000/api/detect', {
            method: 'POST',
        ...
        let response = await fetch('http://ttsh-backend.gsgse7cgfjf9ggf6.eastus.azurecontainer.io:3000/api/translate', {
            method: 'POST',
            headers: {'Content-Type': 'application/json'},
